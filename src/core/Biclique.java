...
public class Biclique implements Externalizable {
	...
	@XmlElement
	/**
	 * The dimension d of the biclique: A biclique of dimension (d,e) tests a group of 2^{d+e} keys.  
	 */
	public int dimension = -1;
	@XmlElement
	/**
	 * The dimension e of the biclique: A biclique of dimension (d,e) tests a group of 2^{d+e} keys.  
	 */
	public int dimension2 = -1;
	@XmlElement
	/**
